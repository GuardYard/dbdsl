 ...
 * @generated
 */
public class DbDSLSwitch<T> extends Switch<T>
{
  /**
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case DbDSLPackage.ABSTRACT_TYPE:
      {
      ...
      case DbDSLPackage.PRIMARY_KEY:
      {
        ...
        if (result == null) result = caseAbstractType(primaryKey);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case DbDSLPackage.COLUMN:
      {
        ...
        if (result == null) result = caseAbstractType(column);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
